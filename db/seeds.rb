...
Employee.create({ username: "chris", password: "12345", email: "chris@skookum.com", name: "Chris Brown", title: "Manager, Denver Devs", bio: "Find me cycling around Denver, writing code at @Skookum, and hanging out with nerds at @Denver-Devs. Formerly of the @ctcidealab hacker space.", location_id: 2, manager_id: nil})
Employee.create({ username: "faruq", password: "12345", email: "faruq@skookum.com", name: "Faruq Rushdie", title: "Manager, Charlotte Devs", bio: "Faruq likes to do stuff", location_id: 1, manager_id: nil})
Employee.create({ username: "sarah", password: "12345", email: "sarah@skookum.com", name: "Sarah  Abramov", title: "Manager, Remote Devs", bio: "Sarah may or may not exist in real life", location_id: 3, manager_id: nil})
Employee.create({ username: "andre", password: "12345", email: "andre@skookum.com", name: "Andre Pohl", title: "Developer", bio: "Andre is tall and smart and nice", location_id: 2, manager_id:  1})
...
Employee.create({ username: "melanie", password: "12345", email: "dev@skookum.com", name: "Melanie Pham", title: "Developer", bio: "Melanie works remotely", location_id: 3, manager_id:  3})
Employee.create({ username: "Fatima", password: "12345", email: "fatima@skookum.com", name: "Fatima Ruiz", title: "Developer", bio: "Fatima rides her bike around Charlotte", location_id: 3, manager_id:  2})
